...
- **38 trademark candidates** across product names, technology brands, 26+ currency names, and 14 module names
- Core marks: **[ i ]**, **POP**, **Attention Wallet**, **iCoin**, **Elo**
- Currency family: **iCoin**, **vCoin**, **aCoin**, **rCoin** + 22 more

### Trade Secrets

- **28 classified trade secrets** including scoring algorithms, fraud detection formulas, settlement policies, and trust tier calculations
- 6 Critical-level secrets that represent core competitive advantage
- These are deliberately NOT patented to avoid public disclosure

### Copyright

- **58+ copyrightable works** including source code (9,500+ files), 58 HTML prototypes, technical documentation corpus, and 249-file knowledge base

---

## What Is Patentable?

**35 utility patent candidates** and **3 design patent candidates** have been identified and scored. Highlights:

| Rank | Invention | Why it's patentable | Score |
|------|-----------|-------------------|-------|
| 1 | Autonomous Execution Kernel (Intent OS) | No prior art for ordered safety gate chain in gaze-driven autonomous execution | 29/30 |
| 2 | Six-Layer POPS Scoring Engine | Novel multimodal proof framework with 6 independent dimensions | 29/30 |
| 3 | Two-Step Server-Recomputed Reward | Client never sends amounts; server recomputes from raw data | 28/30 |
| 4 | Time-Weighted Attention Scoring | Multimodal EMA with face/eyes/gaze/pose fusion | 27/30 |
| 5 | Elo Doctrine-Safe AI Companion | Financial-fraud-aware AI safety system unique to attention economy | 26/30 |

---

## What Is Defensible?

### Moat Architecture (5 Layers)

**Layer 1: Attention Verification (deepest moat)**
- POP system creates verified human attention — the atomic unit of the economy
- Protected by: 8 patent applications, 6 trade secrets, complex implementation

**Layer 2: Economic Infrastructure**
- 26-letter currency taxonomy with append-only ledger and invariant rules
- Protected by: 6 patent applications, 8 trade secrets, network effects

**Layer 3: AI Safety**
- Elo doctrine prevents financial manipulation through the AI companion channel
- Protected by: 3 patent applications, 2 trade secrets (regex patterns)

**Layer 4: Autonomous Interface**
- Intent OS with safety gate chain — first gaze-driven autonomous execution kernel
- Protected by: 5 patent applications, 2 trade secrets (thresholds)

**Layer 5: UX Design**
- Immersive glass shell, gesture-economy vocabulary, pending-first wallet
- Protected by: 3 design patents, gesture vocabulary patent, trade dress potential

### Why Competitors Cannot Easily Replicate

1. **Vertical integration depth** — from camera pixel transport to settlement ledger
2. **Multi-system dependencies** — copying one layer without the others provides no value
3. **Trade secret combination** — exact scoring weights, fraud rules, and thresholds are never published
4. **First-mover advantage** — no existing system verifies attention as a prerequisite for economic actions
5. **Patent breadth** — 42 applications across 10 families create a patent thicket
...
## What Should Remain Trade Secret?
...
| Calibration residual coefficients | Synthetic gaze attacks require knowing correction vectors |

These trade secrets provide an additional **invisible moat** beyond the patent portfolio.
...
## IP Portfolio Valuation Framework
