-- 222_admin_security_trust_ai_analyst_anomaly_governance_intelligence_v2.sql
-- Trust AI analyst, anomaly findings, risk scores, recommended actions, analyst events.
...
-- ---------------------------------------------------------------------------
-- run_scheduled_job — extend allowlist for trust AI analyst v2 (after AI functions)
-- ---------------------------------------------------------------------------
-- run_scheduled_job body from 220 §20 + trust AI analyst allowlist branches
-- ---------------------------------------------------------------------------
