...
bool meanEarIsBlinking({
  required bool wasBlinking,
  required double avgEar,
  required bool hasFace,
  required double closeThreshold,
  required double openThreshold,
}) {
  return hasFace &&
      avgEar > 0 &&
      (wasBlinking ? avgEar < openThreshold : avgEar < closeThreshold);
}

double? meanEarFromPairIfFinite({
