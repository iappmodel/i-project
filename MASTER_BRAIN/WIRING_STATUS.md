...
| Item | Notes |
|------|-------|
| React gaze signals | `VisionProvider` mounted; active vision runtime now respects `remoteControlSettings` (mirror/invert/reach/backend) on Earn + Watch behind `VITE_VISION_ENGINE`; blink-remote UI still deferred |
