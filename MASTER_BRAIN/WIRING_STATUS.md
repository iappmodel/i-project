...
| Item | Notes |
|------|-------|
| React gaze signals | `VisionProvider` mounted; runtime respects `remoteControlSettings`; gesture dispatch bridge active on Earn/Watch behind `VITE_VISION_ENGINE`; blink-remote UI still deferred |
