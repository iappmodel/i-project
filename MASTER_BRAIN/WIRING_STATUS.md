...
| `./scripts/smoke_investor_explainers.sh` | Investor explainer index + presenter deck + 16 HTML walkthroughs |
| `./scripts/open_investor_presenter.sh` | Open consolidated 16-slide presenter deck in browser |
