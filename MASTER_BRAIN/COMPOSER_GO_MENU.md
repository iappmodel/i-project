...
| `GO H2.3` | harvest | C | `smoke_immersive_shell.sh` | ledger |
| `GO H2.4` | harvest | C | `OutProfileChip` + follow | ledger |
| `GO H2.5` | harvest | C | `SavedScreen` + Supabase | ledger |
| `GO H2.6` | harvest | C | `submit-promotion-review` | ledger |
...
|------------|--------|-------|------|------------|
| `GO H3.1` | harvest | C | `get-nearby-promotions` | — |
...
|------------|--------|-------|------|-------------|
| `GO H5.1` | harvest | C | TaskCenter sheet | Yes (Cloud Agent) |
...
| GO command | Branch | Model | Exit | Parallel OK |
|------------|--------|-------|------|-------------|
| `GO H8.1` | harvest | C | Calibration wizard | Yes |
...
| GO command | Branch | Model | Exit | Parallel OK |
|------------|--------|-------|------|-------------|
| `GO design-tokens` | `main` | C | `smoke_gesture_buttons.sh` | Yes |
...
**Start here:** `GO H2.3` → `GO H2.4` → `GO H2.5` (or `GO wire owner gates` when secrets ready)
